const EpisodesAddOn = [
  ...
  // Season 5 - Episode 10
  {
    deaths: [
      `Three owl people`,
      `Multiple versions of Rick - Rick D-716`,
      `Multiple versions of Rick - Supreme Guard Ricks`,
      `Multiple versions of Rick - Guard Ricks`,
      `Multiple versions of Morty - Hunchback Morty`,
      `Multiple versions of Morty - Manly Morty`,
    ...
    description: `"Rickmurai Jack" is the tenth and final episode of the fifth season of Rick and Morty, and the 51st episode of the series overall. It premiered on September 5, 2021. It was written by Jeff Loveness[3] and Scott Marder and directed by Jacob Hair.`,
    errors: [
    ...
    id: 51,
    image: `https://i.pinimg.com/originals/cd/59/d3/cd59d3d671cfdfcc5e9d8b929cf58ba5.jpg`,
    locations: [
      `Replacement Dimension - Earth - Smith Residence`,
      `Central Finite Curve - The Citadel`,
    ],
    name: `Rickmurai Jack`,
    songs: [
      `unknown`,
    ],
    synopsis: `Rick's still doing the crows thing, but a middle-aged Morty hopes to reconnect with Rick, leading them down an emotional path in a familiar location.`,
  },
];
