    ...
    <div>
      ...
      >
        ...
        >
          ...
          {/* Card episode */}
          <Card.Text className="text-truncate px-2 m-1">
            {episode ? episode : ''}
          </Card.Text>
          {/* Card air date */}
          <Card.Text className="text-truncate px-2 m-1">
